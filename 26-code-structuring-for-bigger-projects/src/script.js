...
const world = new Experience(document.querySelector('canvas.webgl'));
...
// const Robot = (name, color) => {
//   name = name;
//   color = color;
//   const sayHi = () => {
//     return `Hi, my name is ${name} and I am ${color}`;
//   };
...
//   };
// };
// const robot = Robot('John', 'red');
// console.log(robot.sayHi());

// const FlyingRobot = (name, color) => {
//   const robot = Robot(name, color);
...
// const flyingRobot = FlyingRobot('John', 'red');
// console.log(flyingRobot.fly());
