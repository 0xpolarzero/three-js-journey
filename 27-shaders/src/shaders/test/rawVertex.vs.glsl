// these values are the same for all vertices of the geometry: uniforms
// Translates the coordinates into the final clip space coordinates
uniform mat4 projectionMatrix;
// Translates the transformations relative to the camera
uniform mat4 viewMatrix;
// Translates the transformations relative to the mesh
